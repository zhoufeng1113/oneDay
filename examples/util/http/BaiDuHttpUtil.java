...
public class BaiDuHttpUtil {
    ...
    // AK
    public static final String BAIDU_GEOCONV_KEY = "82pAjj7BLy2QlvRfIcfwFoBa98mHKKeE";
    ...
    private static String urlEncode(String source) {
        ...
        try {
            result = java.net.URLEncoder
                    .encode(source, BaiDuHttpUtil.ENCODE_CHARSET);
